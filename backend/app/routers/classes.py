...
from app.schemas.entities import DetailMessage, StudyClassCreate, StudyClassResponse, StudyClassUpdate, TuitionSummaryResponse
...
def get_classes(
    ...
    if actor.role == "student":
        ...
        raise HTTPException(status_code=403, detail="Only staff, the owning student, or the assigned tutor can view classes")
