# -*- coding: utf-8 -*-
"""Patch seed: STUDY_CLASS → CLASS_SCHEDULE → LESSON_SESSION → INVOICE → PAYMENT"""
...
with engine.begin() as conn:
    # pick up to 50 assignments that don't yet have a STUDY_CLASS (including CANCELED ones)
    ...
    """)).fetchall()]
    print(f"Available assignment_ids without class: {len(avail_aids)}")
    ...
    # ─────────────────────────────────────────────────────────────────
    # CLASS_SCHEDULE — 50 unique (class, day, start, end) slots
    # ─────────────────────────────────────────────────────────────────
    print("\n=== CLASS_SCHEDULE ===")
    used = set()
    sched_rows = []; attempts = 0
    ...
    # ─────────────────────────────────────────────────────────────────
    # TUITION_INVOICE — 50 rows (snapshot, paid=0 initially)
    # ─────────────────────────────────────────────────────────────────
    print("\n=== TUITION_INVOICE ===")
    inv_rows = []
    ...
    # ─────────────────────────────────────────────────────────────────
    # TUITION_PAYMENT — 50 rows (safe SUCCESS payments)
    # ─────────────────────────────────────────────────────────────────
    print("\n=== TUITION_PAYMENT ===")
    ...
    for t in tables:
        ...
        flag = "✓" if r >= 50 else "✗ NEEDS ATTENTION"
        print(f"  {flag}  {t}: {r}")
